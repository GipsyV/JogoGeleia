window.onload = function () {
    ...
    function randomizeCloud(id){
        ...
        cloudY[id] = -50 + Math.random()*600;
        size[id] = 20 + 30*Math.random();
    ...
    function drawCloud(x,y, size){
        ...
        context.fill();
        context.arc(dist+40, y, size*1.2, 0, 2 * Math.PI);
        context.fill();
        context.arc(dist+80, y+5, size, 0, 2 * Math.PI);
        context.fill();
    ...
    function drawLevel(levelNumber){
        ...
        if(levelNumber < 10){
            context.fillRect(60, 150, 210, 80);
        }else{
            context.fillRect(60, 150, 230, 80);
        }
        ...
        context.fillText("LEVEL " + levelNumber, 70, 210);
    }
    ...
    function telaFinal(){
        ...
        context.clearRect(0, 0, 350, 600);
        context.fillStyle = "black";
        context.fillRect(0, 0, 350, 600);
        context.fillStyle = 'white';
        context.font = '50px serif';
        if(totalLevels == levelNumber){
            context.fillText("Você venceu!",30, 150);
        }else{
            context.fillText("Você perdeu!",30, 150);
        }
        
        context.font = '25px Arial';
        context.fillText("Pontos: " + score, 60, 250);
        context.fillText("Inimigos mortos: " + mortes, 60, 280);
    }
    
    //Mostra a vida total do personagem
    function drawVida(vida) {
        context.fillStyle = "red";
        context.fillRect(140, 10, 200, 25);
